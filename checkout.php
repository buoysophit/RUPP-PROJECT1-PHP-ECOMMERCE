    ...
    <form action="" method="POST">
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                ...
                <input type="text" name="flat" placeholder="flat" class="box" maxlength="50" required>
            </div>
            <div class="inputBox">
            ...
            <div class="inputBox">
                <span>city :</span>
                <input type="text" name="city" placeholder="phnum penh" class="box" maxlength="50" required>
            </div>
            <div class="inputBox">
                <span>state :</span>
            ...
            <div class="inputBox">
                <span>country :</span>
                <input type="text" name="country" placeholder="cambodia" class="box" maxlength="50" required>
            </div>
            <div class="inputBox">
                <span>pin code :</span>
